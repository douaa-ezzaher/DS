...
![Distribution de l’âge](age_distribution.PNG)
...
![Répartition des catégories de CGPA](cgpa_distribution.PNG)
...
![Présence d’au moins un trouble mental](mental_issue_dist.png)
...
![Trouble mental selon le genre](mental_issue_gender.png)
![Trouble mental selon l'année d'étude](mental_issue_year.png)
...
![Heatmap Age / trouble mental](heatmap_age_mental.png)
![Heatmap CGPA / trouble mental](heatmap_cgpa_mental.png)
...
![Matrice de confusion Random Forest](confusion_rf.png)
...
![Courbe ROC du meilleur modèle](roc_best_model.png)
